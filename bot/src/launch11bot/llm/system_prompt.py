...
- ask_question(question, preamble?, options?): единственный способ спросить. Ровно ОДИН вопрос.
  После него ход заканчивается — жди ответ человека. Если предлагаешь выбор из вариантов —
  ОБЯЗАТЕЛЬНО передай их в options: выбор человека засчитает КОД, а не ты.
